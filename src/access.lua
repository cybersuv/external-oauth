...
function redirect_to_auth( conf, callback_url )
    ...
    local oauth_authorize = conf.authorize_url .. "?response_type=code&response_mode=form_post&client_id=" .. conf.client_id .. "&redirect_uri=" .. callback_url .. "&scope=" .. conf.scope
